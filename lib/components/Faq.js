...
export default class Faq {
    ...
    getFAQFromURL(faqURL){
        ...
        $.get(faqURL, function(data, status){
            ...
            let depth, parent1, parent2, parent3, parent4, parents, questionStyle;

            $(elementsWithQuestionMark).each(function(element){
                parents = $(this).parents();

                depth = parents.length;
                questionStyle = $(this).attr('class');
                ...
                questionRecognizer.set('class', questionStyle);
            ...
            let questionCandidates = $(tmp).find(questionSelector).filter(function(){
                if(typeof mostCommonIdentifier.get('class')  !== "undefined" &&
                    $(this).attr('class') != mostCommonIdentifier.get('class')){
                    return false;
                }
